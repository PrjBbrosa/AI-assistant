...
- **单篇长度**（蜗杆 pilot 实践）：术语 400–600 字为佳；低于 350 字说明深度不足，高于 800 字应考虑拆篇或下放到"方法总览"
...
**P0 单篇质量门槛**：400+ 字、≥ 3 个典型值场景、必须有 DIN/VDI/ISO 条款出处。P2 允许"一句话一个场景无出处"，但必须在 frontmatter/首段注明"暂缺完整展开"。
