...
class BaseChapterPage(QWidget):
    ...
    def __init__(self, title: str, subtitle: str, parent: QWidget | None = None) -> None:
        ...
        title_block.setMinimumWidth(300)
        ...
        content_splitter.setSizes([220, 980])
