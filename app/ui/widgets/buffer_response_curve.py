...
_ZERO = QColor("#BBAE9B")
_MARKER = QColor("#D97757")
_BOTTOM_OUT = QColor("#9D4F37")
...
class BufferResponseCurveWidget(QWidget):
    ...
    def paintEvent(self, _event) -> None:  # noqa: N802
        ...
        painter.setPen(QPen(_CURVE, 2.0))
    ...
    def _draw_grid(self, painter: QPainter, plot: QRectF, to_px, y_min: float, y_max: float) -> None:
        ...
        if y_min < 0.0 < y_max:
            ...
            painter.setPen(QPen(_ZERO, 1, Qt.PenStyle.DashLine))
    ...
    def _draw_markers(self, painter: QPainter, plot: QRectF, times, values, to_px) -> None:
        ...
        if displacements and len(displacements) == len(times):
            ...
            painter.setPen(QPen(_MARKER, 1.0, Qt.PenStyle.DotLine))
        ...
        if rebound_duration <= 0.0:
            painter.setPen(QPen(_BOTTOM_OUT, 1.2, Qt.PenStyle.DashLine))
