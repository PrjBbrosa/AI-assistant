...
def _build_ui_font_families() -> list[str]:
    ...
    if platform.system() == "Darwin":
        return ["PingFang SC", "Hiragino Sans GB", "MiSans", "Noto Sans CJK SC", "Avenir Next", "SF Pro Text"]
    return ["MiSans", "Noto Sans CJK SC", "DengXian", "Microsoft YaHei UI", "Segoe UI"]


def _build_css_font_family(families: list[str]) -> str:
    return ", ".join(f'"{family}"' for family in families) + ", sans-serif"
